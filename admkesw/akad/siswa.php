...
if ($_POST['btnSMP'])
	...
	//D. KETERANGAN PENDIDIKAN /////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$alamat_sek = cegah($_POST['alamat_sek']);
		$no_sttb = cegah($_POST['no_sttb']);
		$no_skhun = cegah($_POST['no_skhun']);
		...
		$skhun_tgl = nosql($_POST['skhun_tgl']);
		$skhun_bln = nosql($_POST['skhun_bln']);
		$skhun_thn = nosql($_POST['skhun_thn']);
		$tgl_skhun = ("$skhun_thn:$skhun_bln:$skhun_tgl");
		...
		$keahlian_program = cegah($_POST['keahlian_program']);
		...
		if ($s == "edit")
			...
			//nek blm ada
				...
				{
				//insert
				mysql_query("INSERT INTO m_siswa_pendidikan(kd, kd_siswa, lulusan, alamat_sekolah, ".
								"tgl_sttb, no_sttb, skhun_tgl, skhun_nomor, lama) VALUES ".
								"('$x', '$swkd', '$lulusan', '$alamat_sek', ".
								"'$tgl_sttb', '$no_sttb', '$tgl_skhun', '$no_skhun', '$lama')");
				}
			...
			//nek blm ada
				...
				mysql_query("INSERT INTO m_siswa_diterima(kd, kd_siswa, kelas, keahlian, tgl) VALUES ".
								"('$x', '$swkd', '$kelas', '$keahlian_program', '$tgl_diterima')");
				}
		...
		if ($s == "edit")
			...
			//nek blm ada
				...
				mysql_query("INSERT INTO m_siswa_perkembangan(kd, kd_siswa, bea_siswa, ".
								...
								"tamat, no_sttb, no_skhun, pindah_kelas, no_surat, ket, alumni) VALUES ".
								"('$x', '$swkd', '$bea_siswa', ".
								"'$tgl_tinggal', '$tgl_terima_ijazah', '$tgl_ijazah', '$today', '$alasan', ".
								"'$tamat', '$no_sttb', '$no_skhun', '$pindah_kelas', '$no_surat', '$ket', '$st_alumni')");
				}
...
if (empty($tapelkd))
	...
	if (($s == "baru") OR ($s == "edit"))
		...
		if ($a == "d")
			...
			$y_alamat_sekolah = balikin2($rnil['alamat_sekolah']);
			...
			$y_skhun_nomor = balikin($rnil['skhun_nomor']);
			...
			$y_keahlian_program = balikin2($rnil3['keahlian']);
			...
			<td width="10">: </td>
			<td>
			<input name="alamat_sek" type="text" value="'.$y_alamat_sekolah.'" size="50">
			</td>
			</tr>
			...
			<td width="200">
			<dd>
			d. Tanggal dan No. SKHUN
			</dd>
			</td>
			<td width="10">: </td>
			<td>
			<select name="skhun_tgl">
			<option value="'.$y_tgl_skhun.'" selected>'.$y_tgl_skhun.'</option>';
			for ($i=1;$i<=31;$i++)
				{
				echo '<option value="'.$i.'">'.$i.'</option>';
				}
			...
			echo '</select>
			<select name="skhun_bln">
			<option value="'.$y_bln_skhun.'" selected>'.$arrbln1[$y_bln_skhun].'</option>';
			for ($j=1;$j<=12;$j++)
				{
				echo '<option value="'.$j.'">'.$arrbln[$j].'</option>';
				}
			...
			echo '</select>
			<select name="skhun_thn">
			<option value="'.$y_thn_skhun.'" selected>'.$y_thn_skhun.'</option>';
			for ($k=$sttb01;$k<=$sttb02;$k++)
				{
				echo '<option value="'.$k.'">'.$k.'</option>';
				}
			echo '</select>
			 /
			<input name="no_skhun" type="text" value="'.$y_skhun_nomor.'" size="10">
			</td>
			</tr>
			...
			<td width="10">: </td>
			<td>
			<input name="keahlian_program" type="text" value="'.$y_keahlian_program.'" size="30">
			</td>
			</tr>
		...
		if ($a == "i")
			...
			<tr valign="top">
			<td width="200">
			54. Meninggalkan Sekolah / Keluar
			</td>
			<td width="10"></td>
			<td></td>
			</tr>
			...
			<td width="200">
			<dd>
			a. Tanggal Meninggalkan Sekolah / Keluar
			</dd>
			</td>
			<td width="10">: </td>
			<td>
			...
			<td width="200">
			<dd>
			d. Tanggal Terima Ijazah / Tanggal SKHUN 
			</dd>
			</td>
			<td width="10">: </td>
			<td>
			...
			<td width="10">: </td>
			<td>
			<input name="no_skhun" type="text" value="'.$y_no_skhun.'" size="30">
			</td>
			</tr>
