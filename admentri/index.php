	...
	if ($ku_no == "2")
		...
		if ($total != 0)
			...
			do
				...
				<td>
				<a href="ajar2/nil_pengetahuan.php?mmkd='.$dty_gurkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$mpkd.'&mpkd='.$mpkd.'"
				title="Kelas = '.$btxkelas.', Pelajaran = '.$dti_pel.'">
				<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
				</td>
				<td>
				<a href="ajar2/nil_ketrampilan.php?mmkd='.$dty_gurkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$mpkd.'&mpkd='.$mpkd.'"
				title="Kelas = '.$btxkelas.', Pelajaran = '.$dti_pel.'">
				<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
				</td>
				<td>
				<a href="ajar2/nil_sikap.php?mmkd='.$dty_gurkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$mpkd.'&mpkd='.$mpkd.'"
				title="Kelas = '.$btxkelas.', Pelajaran = '.$dti_pel.'">
				<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
				</td>
				</tr>';
