...
if ($_POST['btnSMP'])
	...
	for ($k=1;$k<=$limit;$k++)
		...
		$xnilnrxx = round(((3 * $xnilnpxx) + (2 * $xnilnyxx) + $xnilnfxx) / 6);
...
if ($_POST['btnEX'])
	...
	//nama file e...
	$excelfile = "Nilai_Ketrampilan_$stdx_pel.xls";
	...
	$myArr = array("NO","NIS","NAMA","NP_1","NP_2","NP_3","NP_4","RATA_NP",
						"NF_1","NF_2","NF_3","NF_4","RATA_NF","NY_1","NY_2","NY_3",
						"NY_4","RATA_NY","NR","RAPORT_A","RAPORT_P","CATATAN");
	...
	do
		...
		$xpel_catatan = balikin($rxpel['nil_k_ketrampilan']);
		...
		//ciptakan
		$myArr = array($dt_nox,$dt_nis,$dt_nama,$xpel_nil_np1,$xpel_nil_np2,$xpel_nil_np3,$xpel_nil_np4,$xpel_rata_np,
						$xpel_nil_folio1,$xpel_nil_folio2,$xpel_nil_folio3,$xpel_nil_folio4,$xpel_rata_nf,
						$xpel_nil_proyek1,$xpel_nil_proyek2,$xpel_nil_proyek3,$xpel_nil_proyek4,$xpel_rata_ny,
						$xpel_nil_nr,$xpel_nil_nr_a,$xpel_nil_nr_p,$xpel_catatan);
		$excel->writeLine($myArr);
...
if (empty($tapelkd))
	...
	if ($s == "import")
		...
		do
			...
			$xpel_nil_nr_a = balikin($rxpel['nil_raport_ketrampilan_a']);
			$xpel_nil_nr_p = balikin($rxpel['nil_raport_ketrampilan_p']);
			$xpel_nil_k = balikin($rxpel['nil_k_ketrampilan']);
