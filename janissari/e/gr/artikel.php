...
//nek mapel telah dipilih
	...
	if ($tpel != 0)
		...
		if (($s == "edit") OR ($s == "baru"))
			...
			//pecah titik - titik
			$dt_rangkumanx = pathasli2($dt_rangkuman);
			$dt_isix = pathasli2($dt_isi);
			...
			<br>
			<textarea name="rangkumanx" cols="50" rows="5" wrap="virtual">'.$dt_rangkumanx.'</textarea>
			</p>
			...
			<textarea id="editor" name="editor" rows="20" cols="80" style="width: 100%">'.$dt_isix.'</textarea>
			</p>
		...
		//jika daftar //////////////////////////////////////////////////////////////////////////////////
			...
			if ($count != 0)
				...
				do
					...
					$dt_rangkuman = pathasli2(balikin($data['rangkuman']));
