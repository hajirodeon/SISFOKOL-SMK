...
//nek mapel telah dipilih
	...
	if ($tpel != 0)
		...
		$judul = "$pel_nm [Guru : $pel_usnm] --> Artikel";
		...
		if ($s == "detail")
			...
			//log
			$nilku = "Membaca Artikel : $dt_judul";
			...
			//daftar komentar ////////////////////////////////////////////////////////
			$qdko = mysql_query("SELECT * FROM guru_mapel_artikel_msg ".
			...
			if ($a_count != 0)
				...
				do
					...
					//jml komentar
					$qjko = mysql_query("SELECT * FROM guru_mapel_artikel_msg ".
...
*/
			...
			if ($count != 0)
				...
				do
					...
					//detail
					$qku = mysql_query("SELECT guru_mapel.*, guru_mapel_artikel.*, guru_mapel_artikel.kd AS nkd ".
								"FROM guru_mapel, guru_mapel_artikel ".
								"WHERE guru_mapel_artikel.kd_guru_mapel = guru_mapel.kd ".
								"AND guru_mapel_artikel.kd = '$dt_kd' ".
								"AND guru_mapel.kd = '$gmkd'");
				...
				{
				echo '<font color="blue"><strong>TIDAK ADA Artikel. </strong></font>';
				}
