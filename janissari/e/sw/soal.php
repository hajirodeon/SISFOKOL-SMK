...
//nek mapel telah dipilih
	...
	if ($tpel != 0)
		...
		if ($a == "detail")
			...
			//log
			$nilku = "Mengerjakan Soal : $dt_judul";
		...
		//jika daftar topik/judul ///////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$sqlcount = "SELECT DISTINCT(guru_mapel_soal.kd) AS katkd ".
					"FROM guru_mapel_soal ".
			...
			if ($count != 0)
				...
				do
					...
					//detail
					$qku = mysql_query("SELECT guru_mapel_soal.* ".
								"FROM guru_mapel_soal ".
								"WHERE guru_mapel_soal.kd = '$kd'");
					$rku = mysql_fetch_assoc($qku);
					$judulx = balikin($rku['judul']);
					$bobot = nosql($rku['bobot']);
					$waktu = nosql($rku['waktu']);
