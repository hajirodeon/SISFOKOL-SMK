...
do
	...
	echo '<option value="'.$sumber.'/janissari/e/sw/mapel.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smtkd='.$smtkd.'&progkd='.$std_kd.'&s=detail&gmkd='.$std_kd.'&pegkd='.$uru_kd.'">'.$std_pel.' ['.$uru_nip.']. ['.$uru_nama.'].</option>';
	}
