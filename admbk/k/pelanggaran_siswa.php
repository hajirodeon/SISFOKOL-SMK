...
if ($_POST['btnSMPx2'])
	...
	if ((empty($jnskd)) OR (empty($pelkd)))
		...
		mysql_query("INSERT INTO siswa_pelanggaran (kd, kd_tapel, kd_kelas, ".
				"kd_siswa, tgl, kd_point, postdate) VALUES ".
				"('$x', '$tapelkd', '$kelkd', ".
...
var config = {
	source: "i_siswa.php?tapelkd="+tapelkd+"&kelkd="+kelkd,
//	source: "i_siswa.php",
...
if ($s == "baru")
	...
	if (empty($tapelkd))
		...
		<input type="text" name="p_nama" id="p_nama" value="'.$e_nama.'" size="30" class="input" readonly>
		<br>
		<br>
