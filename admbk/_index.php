...
if ($_POST['btnSMP'])
	...
	do
		...
		$xkst = "predikat";
		$xkst1 = "$t_kd$xkst$noxzi";
		$xkstxx = nosql($_POST["$xkst1"]);

		$xket = "ket";
		$xket1 = "$t_kd$xket$noxzi";
	...
	if ($count != 0)
		...
		do
			...
			do
				...
				echo '<td>
				<INPUT type="hidden" name="skkd'.$i_nomer.'" value="'.$skkd.'">
				<select name="'.$dt_kd.'predikat'.$i_nomer.'">
				...
				<input name="'.$dt_kd.'ket'.$i_nomer.'" type="text" size="10" value="'.$prix_ket.'">
				</td>';
				}
			while ($rdt = mysql_fetch_assoc($qdt));
