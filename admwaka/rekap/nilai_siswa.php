...
//nilai
$filenya = "nilai_siswa.php";
$judul = "Rekap Nilai Siswa";
...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&kompkd=$kompkd&page=$page";
...
if (empty($tapelkd))
	...
	{
	echo '[<a href="nilai_siswa_xls.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smtkd='.$smtkd.'" target="_blank" title="Legger Nilai">EXCEL</a>]';
	}
