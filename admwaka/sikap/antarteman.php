...
if ($_POST['btnSMP'])
	...
	if (empty($e_no))
		...
		{
		//query
		mysql_query("INSERT INTO m_sikap_antarteman(kd, kd_tapel, no, nama, postdate) VALUES ".
...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysql_query("DELETE FROM m_sikap_antarteman ".
...
if (empty($tapelkd))
	...
	<td><strong><font color="'.$warnatext.'">Aspek Pengamatan</font></strong></td>
	</tr>';
