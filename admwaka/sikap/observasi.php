...
//nilai
$filenya = "observasi.php";
$judul = "Data Sikap Spiritual";
...
if ($_POST['btnSMP'])
	...
	if (empty($e_no))
		...
		{
		//query
		mysql_query("INSERT INTO m_sikap_observasi(kd, kd_tapel, no, nama, postdate) VALUES ".
...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysql_query("DELETE FROM m_sikap_observasi ".
