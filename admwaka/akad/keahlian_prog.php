...
if ($total != 0)
	{
	echo 'Total : <strong><font color="#FF0000">'.$total.'</font></strong> Data.
	<table border="1" cellspacing="0" cellpadding="3">
	<tr valign="top" bgcolor="'.$warnaheader.'">
	<td width="1">&nbsp;</td>
	<td width="1">&nbsp;</td>
	<td width="250"><strong><font color="'.$warnatext.'">Program Keahlian</font></strong></td>
	</tr>';
