				...
				if (empty($gkd))
					...
					do
						...
						if (!empty($e_postdate))
							...
							[Semester : <b>'.$st_smt.'</b>].
							[<a href="guru_silabus_view.php?gkd='.$gkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&keahkd='.$keahkd.'&progkd='.$pelkd.'&mpkd='.$pelx_mpkd.'&kompkd='.$kompkd.'&smtkd='.$st_kd.'" target="_blank"><img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>]. 
							<br>
