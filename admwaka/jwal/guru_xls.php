...
$qjw = mysql_query("SELECT DISTINCT(m_prog_pddkn.kd) AS progkd ".
						"FROM jadwal, m_guru_prog_pddkn, m_guru, m_prog_pddkn, m_kelas ".
...
do
	...
	$ku_kode = strip(nosql($rku['xpel']));
	$ku_prog_pddkn = balikin($rku['prog_pddkn']);
	...
	$sheet->setCellValue('B3', ': '.$ku_kode.' ['.$ku_prog_pddkn.']');
...
//			$barisku = ($thri * ($k)) + (6 + $k) - $thri;
			...
			if (!empty($dte_ket))
				...
				$qdte2 = mysql_query("SELECT jadwal.kd AS jdkd, ".
										"jadwal.kd_guru_prog_pddkn AS gpkd, ".
										"m_guru.kd_kelas AS kelkd ".
										"FROM jadwal, m_guru_prog_pddkn, m_guru ".
										"WHERE jadwal.kd_guru_prog_pddkn = m_guru_prog_pddkn.kd ".
										"AND m_guru_prog_pddkn.kd_guru = m_guru.kd ".
										"AND m_guru_prog_pddkn.kd_guru = '$btxgurkd' ".
										"AND m_guru.kd_tapel = '$tapelkd' ".
										"AND m_guru_prog_pddkn.kd_prog_pddkn = '$i_progkd' ".
										"AND jadwal.kd_tapel = '$tapelkd' ".
										"AND jadwal.kd_smt = '$smtkd' ".
