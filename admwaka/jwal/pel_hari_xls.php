...
//nama file
$i_filename = "guru_mapel_hari-$tapelnya-$harinya-$smtnya.xls";
...
$sheet = $objPHPExcel->setActiveSheetIndex(0)->setTitle('JADWALHARI'.$harinya.'');
...
//header
$sheet->setCellValue('A1', 'JADWAL MATA PELAJARAN PER HARI : '.$harinya.'');
