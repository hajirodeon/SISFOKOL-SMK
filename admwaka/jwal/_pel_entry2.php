...
$pelx_pegkd = nosql($rpelx['kd_pegawai']);
...
$pelx_pel = balikin($r1['prog_pddkn']);

//pegawai
$q2 = mysql_query("SELECT * FROM m_pegawai ".
			"WHERE kd = '$pelx_pegkd'");
$r2 = mysql_fetch_assoc($q2);
$pelx_nip = nosql($r2['nip']);
$pelx_nm = balikin($r2['nama']);
...
do
	...
	$pel_pegkd = nosql($rpel['kd_pegawai']);
	...
	$q2 = mysql_query("SELECT * FROM m_pegawai ".
				"WHERE kd = '$pel_pegkd'");
	$r2 = mysql_fetch_assoc($q2);
	$pel_nip = nosql($r2['nip']);
	$pel_nm = balikin($r2['nama']);
