...
function HeaderKu()
	...
	$this->Cell(190,5,'LAPORAN HASIL BELAJAR',0,0,'C');
	$this->Ln();
	$this->Ln();
	...
	$this->Cell(40,5,'Nama Sekolah',0,0,'L');
	$this->Cell(50,5,': '.$sek_nama.'',0,0,'L');
	$this->Ln();
	$this->SetFont('Arial','',12);
	$this->Cell(40,5,'Alamat',0,0,'L');
	$this->Cell(50,5,': '.$sek_alamat.'',0,0,'L');
	$this->Ln();
	$this->Cell(40,5,'Nama',0,0,'L');
	$this->Cell(50,5,': '.$nama.'',0,0,'L');
	$this->Ln();
	$this->Cell(40,5,'No.Induk NIS/NISN',0,0,'L');
	$this->Cell(50,5,': '.$nis.'/'.$nisn.'',0,0,'L');
	$this->Ln();
	
	$this->SetY($nilY);
	$this->SetX(130);
	$this->Cell(30,5,'Kelas',0,0,'L');
	$this->Cell(30,5,': '.$rkel.'',0,0,'L');
	$this->Ln();
	$this->SetX(130);
	$this->Cell(30,5,'Semester',0,0,'L');
	$this->Cell(30,5,': '.$smtno.' ('.$smt.')',0,0,'L');
	$this->Ln();
	$this->SetX(130);
	$this->Cell(30,5,'Tahun Pelajaran',0,0,'L');
	$this->Cell(30,5,': '.$tapel.'',0,0,'L');
	$this->Ln();
	}
...
function HeaderKu2()
    ...
    $this->SetFont('Arial','B',12);
	$this->Cell(190,5,'DESKRIPSI/CATATAN HASIL BELAJAR',0,0,'C');
	$this->Ln();
	$this->Ln();
