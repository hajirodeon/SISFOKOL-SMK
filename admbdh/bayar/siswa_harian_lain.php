...
$ke = "$filenya?jnskd=$jnskd&tapelkd=$tapelkd&uthn=$uthn&ubln=$ubln&utgl=$utgl";
...
{
echo '<br>
[<a href="siswa_harian_lain_prt.php?jnskd='.$jnskd.'&tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
