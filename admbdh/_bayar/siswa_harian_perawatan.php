...
//nilai
$filenya = "siswa_harian_perawatan.php";
$judul = "Laporan Harian : Uang Perawatan";
...
if (empty($tapelkd))
	...
	if ($tcc != 0)
		{
		echo '<br>
		[<a href="siswa_harian_perawatan_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
		...
		<td width="10" align="center"><strong><font color="'.$warnatext.'">perawatan</font></strong></td>
		...
		do
			...
			//ketahui jumlah uang perawatan-nya...
