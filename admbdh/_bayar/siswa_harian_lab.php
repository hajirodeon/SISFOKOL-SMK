...
//nilai
$filenya = "siswa_harian_lab.php";
$judul = "Laporan Harian : Uang Lab.Bahasa";
...
if (empty($tapelkd))
	...
	if ($tcc != 0)
		{
		echo '<br>
		[<a href="siswa_harian_lab_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
		...
		<td width="10" align="center"><strong><font color="'.$warnatext.'">lab</font></strong></td>
