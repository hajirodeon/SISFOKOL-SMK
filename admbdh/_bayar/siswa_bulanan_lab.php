...
//nilai
$filenya = "siswa_bulanan_lab.php";
$judul = "Laporan Bulanan : Uang Lab.Bahasa";
...
echo '</select>
[<a href="siswa_bulanan_lab_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
</td>
</tr>
</table>';
