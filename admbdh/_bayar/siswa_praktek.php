...
//nilai
$filenya = "siswa_praktek.php";
$judul = "Keuangan Siswa : Uang Praktek";
...
if ($s == "hapus")
	...
	//query
	mysql_query("UPDATE siswa_uang_praktek SET lunas = 'false', ".
...
if ($_POST['btnBTL'])
	...
	//cek
	$qswp = mysql_query("SELECT * FROM siswa_uang_praktek ".
				"WHERE kd_siswa = '$swkd' ".
...
if ($_POST['btnSMP'])
	...
	do
		...
		//update
		mysql_query("UPDATE siswa_uang_praktek SET lunas = 'true', ".
				"tgl_bayar = '$today', ".
				"postdate = '$today3', ".
				"nilai = '$nil_uang' ".
				"WHERE kd_tapel = '$tapelkd' ".
	...
	//re-direct
	$ke = "siswa_praktek_prt.php?tapelkd=$tapelkd&nis=$nis";
	xloc($ke);
	exit();
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (!empty($nis))
		...
		for ($i=1;$i<=12;$i++)
			...
			if ($i<=6) //bulan juli sampai desember
				...
				//cek
				$qccu = mysql_query("SELECT * FROM siswa_uang_praktek ".
				...
				if (empty($tccu))
					{
					$xyz = md5("$x$i");
					mysql_query("INSERT INTO siswa_uang_praktek (kd, kd_siswa, kd_tapel, kd_kelas, bln, thn) VALUES ".
		...
		if ($tcc != 0)
			...
			Pembayaran :
			<br>
			<input name="bayar" type="text" value="Uang Praktek" size="30" class="input" readonly>
			</p>
