...
//nilai
$filenya = "siswa_harian_praktek.php";
$judul = "Laporan Harian : Uang Praktek";
...
if (empty($tapelkd))
	...
	if ($tcc != 0)
		{
		echo '<br>
		[<a href="siswa_harian_praktek_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
		...
		do
			...
			//ketahui jumlah uang praktek-nya...
