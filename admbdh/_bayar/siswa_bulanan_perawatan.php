...
//nilai
$filenya = "siswa_bulanan_perawatan.php";
$judul = "Laporan Bulanan : Uang perawatan";
...
echo '</select>
[<a href="siswa_bulanan_perawatan_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
</td>
</tr>
</table>';
