...
if ($_POST['btnBTL'])
	...
	$ke = "nil_kompetensi.php?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&".
		"keahkd=$keahkd&progkd=$progkd&mmkd=$mmkd&mpkd=$mpkd&mpkd=$mpkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex2))
		...
		$ke = "nil_kompetensi.php?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&".
				"keahkd=$keahkd&progkd=$progkd&mmkd=$mmkd&mpkd=$mpkd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
...
//			$hi_mpkd = nosql($rowhi['mpkd']);
			...
			//re-direct
			$ke = "nil_kompetensi.php?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&".
					"keahkd=$keahkd&progkd=$progkd&mmkd=$mmkd&mpkd=$mpkd";
			xloc($ke);
			exit();
			}
		else
