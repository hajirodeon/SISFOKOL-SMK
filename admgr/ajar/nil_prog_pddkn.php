...
//				$xpel_nil_kd = nosql($rxpel['nil_kd']);
				...
				<td>
				<input name="nil_kd'.$i_nomer.'" type="text" value="'.$dtu2_nk.'" size="2" style="text-align:right" class="input" readonly>
				</td>
...
//				$xpel_nil_nh = nosql($rxpel['nil_kd']);
				...
				<td>
				<input name="nil_kd'.$i_nomer.'" type="text" value="'.$xpel_nil_nh.'" size="2" style="text-align:right" class="input" readonly>
				</td>
