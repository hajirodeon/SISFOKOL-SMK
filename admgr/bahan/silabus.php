...
if($_POST['btnSMP'])
	...
	//cek
	$qcc = mysql_query("SELECT * FROM guru_silabus ".
	...
	if (empty($tcc))
		...
		//query
		mysql_query("INSERT INTO guru_silabus(kd, kd_guru_prog_pddkn, kd_smt, isi, postdate) VALUES ".
		...
		{
		//query
		mysql_query("UPDATE guru_silabus SET isi = '$e_isi', ".
						"postdate = '$today' ".
						"WHERE kd_guru_prog_pddkn = '$mmkd' ".
						"AND kd_smt = '$smtkd'");
		}
...
if($_POST['btnRST'])
	...
	//hapus
	$qcc = mysql_query("DELETE FROM guru_silabus ".
							"WHERE kd_guru_prog_pddkn = '$mmkd' ".
							"AND kd_smt = '$smtkd'");
	$tcc = mysql_num_rows($qcc);
