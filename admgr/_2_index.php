...
if (empty($tapelkd))
	...
	if ($tdty != 0)
		...
		do
			...
			<td>
			<a href="ajar/nil_pengetahuan.php?mmkd='.$dty_gurkd.'&tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&progkd='.$dty_pelkd.'&mpkd='.$pelx_mpkd.'&kompkd='.$dty_kompkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
			<a href="ajar/nil_ketrampilan.php?mmkd='.$dty_gurkd.'&tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&progkd='.$dty_pelkd.'&mpkd='.$pelx_mpkd.'&kompkd='.$dty_kompkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
			<a href="ajar/nil_sikap.php?mmkd='.$dty_gurkd.'&tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&progkd='.$dty_pelkd.'&mpkd='.$pelx_mpkd.'&kompkd='.$dty_kompkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
			<a href="'.$sumber.'/janissari/e/gr/mapel.php?tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&kompkd='.$dty_kompkd.'&smtkd='.$smtkd.'&progkd='.$dty_pelkd.'&s=detail&gmkd='.$dty_pelkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			</tr>';
