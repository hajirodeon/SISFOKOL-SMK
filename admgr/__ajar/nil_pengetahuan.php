...
if (empty($tapelkd))
	...
	if ($s == "import")
		...
		do
			...
			<td>
			<input name="nil_nh'.$i_nomer.'" type="text" value="'.$xpel_nil_nh.'" size="3" style="text-align:right">
			</td>
			<td>
			...
			<td>
			<input name="nil_catatan'.$i_nomer.'" type="text" value="'.$xpel_nil_k.'" size="30" style="text-align:right">
			</td>
