...
if ($_POST['btnSMP'])
	...
	for ($k=1;$k<=$limit;$k++)
		...
		$xnilnf = "nil_rata_nf";
		$xnilnf1 = "$xnilnf$k";
		$xnilnfxx = nosql($_POST["$xnilnf1"]);

		$xnilny = "nil_rata_ny";
		$xnilny1 = "$xnilny$k";
		$xnilnyxx = nosql($_POST["$xnilny1"]);

		$xnilnr = "nil_raport";
		$xnilnr1 = "$xnilnr$k";
		$xnilnrxx = nosql($_POST["$xnilnr1"]);

		$xnilnra = "nil_raport_a";
		$xnilnra1 = "$xnilnra$k";
		$xnilnraxx = nosql($_POST["$xnilnra1"]);

		$xnilnrp = "nil_raport_p";
		$xnilnrp1 = "$xnilnrp$k";
		$xnilnrpxx = nosql($_POST["$xnilnrp1"]);
		...
		if ($tcc != 0)
			...
			if ($tcc1 != 0)
				{
				mysql_query("UPDATE siswa_nilai_raport SET rata_praktek = '$xnilnpxx', ".
								"rata_folio = '$xnilnfxx', ".
								"rata_proyek = '$xnilnyxx', ".
...
if ($_POST['btnIM2'])
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".xls")
			...
			//re-direct
			$ke = "nil_ketrampilan_import.php?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&smtkd=$smtkd&progkd=$progkd&jnskd=$jnskd&filex_namex2=$filex_namex2";
			xloc($ke);
			exit();
			}
		else
...
if ($_POST['btnEX'])
	...
	$i_judul = "Nilai_Ketrampilan_$stdx_pel";
	...
	$worksheet1->write_string(0,3,"NP_1");
	$worksheet1->write_string(0,4,"NP_2");
	$worksheet1->write_string(0,5,"NP_3");
	$worksheet1->write_string(0,6,"NP_4");
	$worksheet1->write_string(0,7,"NP_5");
	$worksheet1->write_string(0,8,"NP_6");
	$worksheet1->write_string(0,9,"NP_7");
	$worksheet1->write_string(0,10,"NP_8");
	$worksheet1->write_string(0,11,"NP_9");
	$worksheet1->write_string(0,12,"RATA_NP");
	$worksheet1->write_string(0,13,"NF_1");
	$worksheet1->write_string(0,14,"NF_2");
	$worksheet1->write_string(0,15,"NF_3");
	$worksheet1->write_string(0,16,"NF_4");
	$worksheet1->write_string(0,17,"NF_5");
	$worksheet1->write_string(0,18,"NF_6");
	$worksheet1->write_string(0,19,"NF_7");
	$worksheet1->write_string(0,20,"NF_8");
	$worksheet1->write_string(0,21,"NF_9");
	$worksheet1->write_string(0,22,"RATA_NF");
	$worksheet1->write_string(0,23,"NY_1");
	$worksheet1->write_string(0,24,"NY_2");
	$worksheet1->write_string(0,25,"NY_3");
	$worksheet1->write_string(0,26,"NY_4");
	$worksheet1->write_string(0,27,"NY_5");
	$worksheet1->write_string(0,28,"NY_6");
	$worksheet1->write_string(0,29,"NY_7");
	$worksheet1->write_string(0,30,"NY_8");
	$worksheet1->write_string(0,31,"NY_9");
	$worksheet1->write_string(0,32,"RATA_NY");
	$worksheet1->write_string(0,33,"NR");
	$worksheet1->write_string(0,34,"RAPORT_A");
	$worksheet1->write_string(0,35,"RAPORT_P");
	...
	do
		...
		$xpel_nil_np5 = nosql($rxpel['nil_praktek5']);
		$xpel_nil_np6 = nosql($rxpel['nil_praktek6']);
		$xpel_nil_np7 = nosql($rxpel['nil_praktek7']);
		$xpel_nil_np8 = nosql($rxpel['nil_praktek8']);
		$xpel_nil_np9 = nosql($rxpel['nil_praktek9']);
		...
		$xpel_nil_folio5 = nosql($rxpel['nil_folio5']);
		$xpel_nil_folio6 = nosql($rxpel['nil_folio6']);
		$xpel_nil_folio7 = nosql($rxpel['nil_folio7']);
		$xpel_nil_folio8 = nosql($rxpel['nil_folio8']);
		$xpel_nil_folio9 = nosql($rxpel['nil_folio9']);
		...
		$xpel_nil_proyek5 = nosql($rxpel['nil_proyek5']);
		$xpel_nil_proyek6 = nosql($rxpel['nil_proyek6']);
		$xpel_nil_proyek7 = nosql($rxpel['nil_proyek7']);
		$xpel_nil_proyek8 = nosql($rxpel['nil_proyek8']);
		$xpel_nil_proyek9 = nosql($rxpel['nil_proyek9']);
		...
		$worksheet1->write_string($dt_nox,7,$xpel_nil_np5);
		$worksheet1->write_string($dt_nox,8,$xpel_nil_np6);
		$worksheet1->write_string($dt_nox,9,$xpel_nil_np7);
		$worksheet1->write_string($dt_nox,10,$xpel_nil_np8);
		$worksheet1->write_string($dt_nox,11,$xpel_nil_np9);
		$worksheet1->write_string($dt_nox,12,$xpel_rata_np);
		$worksheet1->write_string($dt_nox,13,$xpel_nil_folio1);
		$worksheet1->write_string($dt_nox,14,$xpel_nil_folio2);
		$worksheet1->write_string($dt_nox,15,$xpel_nil_folio3);
		$worksheet1->write_string($dt_nox,16,$xpel_nil_folio4);
		$worksheet1->write_string($dt_nox,17,$xpel_nil_folio5);
		$worksheet1->write_string($dt_nox,18,$xpel_nil_folio6);
		$worksheet1->write_string($dt_nox,19,$xpel_nil_folio7);
		$worksheet1->write_string($dt_nox,20,$xpel_nil_folio8);
		$worksheet1->write_string($dt_nox,21,$xpel_nil_folio9);
		$worksheet1->write_string($dt_nox,22,$xpel_rata_nf);
		$worksheet1->write_string($dt_nox,23,$xpel_nil_proyek1);
		$worksheet1->write_string($dt_nox,24,$xpel_nil_proyek2);
		$worksheet1->write_string($dt_nox,25,$xpel_nil_proyek3);
		$worksheet1->write_string($dt_nox,26,$xpel_nil_proyek4);
		$worksheet1->write_string($dt_nox,27,$xpel_nil_proyek5);
		$worksheet1->write_string($dt_nox,28,$xpel_nil_proyek6);
		$worksheet1->write_string($dt_nox,29,$xpel_nil_proyek7);
		$worksheet1->write_string($dt_nox,30,$xpel_nil_proyek8);
		$worksheet1->write_string($dt_nox,31,$xpel_nil_proyek9);
		$worksheet1->write_string($dt_nox,32,$xpel_rata_ny);
		$worksheet1->write_string($dt_nox,33,$xpel_nil_nr);
		$worksheet1->write_string($dt_nox,34,$xpel_nil_nr_a);
		$worksheet1->write_string($dt_nox,35,$xpel_nil_nr_p);
		}
...
if (empty($tapelkd))
	...
	if ($s == "import")
		...
		do
			...
			<td>
			<input name="nil_rata_np'.$i_nomer.'" type="text" value="'.$xpel_rata_np.'" size="3" style="text-align:right">
			</td>

			<td>
			<input name="nil_rata_nf'.$i_nomer.'" type="text" value="'.$xpel_rata_nf.'" size="3" style="text-align:right">
			</td>
			<td>
			<input name="nil_rata_ny'.$i_nomer.'" type="text" value="'.$xpel_rata_ny.'" size="3" style="text-align:right">
			</td>
			<td>
			<input name="nil_raport'.$i_nomer.'" type="text" value="'.$xpel_nil_nr.'" size="3" style="text-align:right">
			</td>
			<td>
			<input name="nil_raport_a'.$i_nomer.'" type="text" value="'.$xpel_nil_nr_a.'" size="3" style="text-align:right">
			</td>
			<td>
			<input name="nil_raport_p'.$i_nomer.'" type="text" value="'.$xpel_nil_nr_p.'" size="3" style="text-align:right">
			</td>
			</tr>';
			}
