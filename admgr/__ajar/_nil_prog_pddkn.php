...
if (empty($tapelkd))
	...
	if ($s == "import")
		...
		do
			...
			<td>
			<input name="nil_raport_a'.$i_nomer.'" type="text" value="'.$xpel_nil_raport_a.'" size="3" style="text-align:right" class="input" readonly>
			</td>
			<td>
			<input name="nil_raport_p'.$i_nomer.'" type="text" value="'.$xpel_nil_raport_p.'" size="3" style="text-align:right" class="input" readonly>
			</td>
			<td>
			<input name="nil_catatan'.$i_nomer.'" type="text" value="'.$xpel_nil_catatan.'" size="30" style="text-align:right" class="input" readonly>
			</td>
