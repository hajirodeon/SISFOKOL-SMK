...
if ($_POST['btnBTL'])
	...
	//re-direct
	$ke = "nil_sikap.php?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&progkd=$progkd&jnskd=$jnskd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex2))
		...
		$ke = "nil_sikap.php?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&progkd=$progkd&smtkd=$smtkd&jnskd=$jnskd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
		...
		if ($ext_filex == ".xls")
			...
			for ($i=2; $i<=$baris; $i++)
				...
				$i_nil11 = nosql($data->val($i, 14));
				$i_nil12 = nosql($data->val($i, 15));
				$i_nil13 = nosql($data->val($i, 16));
				$i_nil14 = nosql($data->val($i, 17));
				$i_nil15 = nosql($data->val($i, 18));
				$i_nil16 = nosql($data->val($i, 19));
				...
				if ($tcc != 0)
					...
					if ($tcc1 != 0)
						{
						mysql_query("UPDATE siswa_nilai_raport SET nil_sikap_amat1 = '$i_nil1', ".
										"nil_sikap_amat2 = '$i_nil2', ".
										"nil_sikap_amat3 = '$i_nil3', ".
										"nil_sikap_amat4 = '$i_nil4', ".
										"nil_sikap_amat5 = '$i_nil5', ".
										"nil_sikap_amat6 = '$i_nil6', ".
										"nil_sikap_amat7 = '$i_nil7', ".
										"nil_sikap_amat8 = '$i_nil8', ".
										"nil_sikap_amat9 = '$i_nil9', ".
										"rata_sikap_amat = '$i_nil10', ".
										"nil_sikap_dirisendiri = '$i_nil11', ".
					...
					//jika blm ada, insert
						...
						mysql_query("INSERT INTO siswa_nilai_raport(kd, kd_siswa_kelas, kd_smt, kd_prog_pddkn, ".
										"nil_sikap_amat1, nil_sikap_amat2, nil_sikap_amat3, ".
										"nil_sikap_amat4, nil_sikap_amat5, nil_sikap_amat6, ".
										"nil_sikap_amat7, nil_sikap_amat8, nil_sikap_amat9, ".
