...
if ($_POST['btnBTL'])
	...
	//re-direct
	$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&progkd=$progkd&jnskd=$jnskd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex2))
		...
		$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&progkd=$progkd&smtkd=$smtkd&jnskd=$jnskd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
		...
		if ($ext_filex == ".xls")
			...
			for ($i=2; $i<=$baris; $i++)
				...
				if ($tcc != 0)
					...
					if ($tcc1 != 0)
						{
						mysql_query("UPDATE siswa_nilai_raport SET nil_raport_pengetahuan = '$i_nil', ".
										"nil_raport_pengetahuan_a = '$i_nil1', ".
										"nil_k_pengetahuan = '$i_nil2', ".
										"postdate = '$today' ".
										"WHERE kd_siswa_kelas = '$cc_skkd' ".
										"AND kd_smt = '$smtkd' ".
										"AND kd_prog_pddkn = '$progkd'");
			...
			$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&smtkd=$smtkd&progkd=$progkd&jnskd=$jnskd&s=import";
			pekem($pesan,$ke);
			exit();
			}
		}
