...
if ($_POST['btnEX'])
	...
	//bikin...
	$myArr = array("NO","NIS","NAMA","DIRISENDIRI","ANTARTEMAN","CATATANGURU","NILAI_AKHIR","RAPORT_A","RAPORT_P", "CATATAN");
	...
	do
		...
		//ciptakan
		$myArr2 = array($dt_nox,$dt_nis,$dt_nama,$xpel_nil_dirisendiri,$xpel_nil_antarteman,$xpel_nil_catatanguru,$xpel_rata_sikap,$xpel_raport_a,$xpel_raport_p, $xpel_catatan);
