...
if ($_POST['btnSMP'])
	...
	for ($k=1;$k<=$limit;$k++)
		...
		$xnil5 = round(((2 * $xnil1) + $xnil2 + $xnil3 + $xnil4) / 4);
		$xpel_sikap = $xnil5;
		$xnil6 = $xnil5;
...
if ($_POST['btnEX'])
	...
	//bikin...
	$myArr = array("NO","NIS","NAMA","AMAT_1","AMAT_2","AMAT_3","AMAT_4","RATA_AMAT","DIRISENDIRI","ANTARTEMAN","CATATANGURU","NILAI_AKHIR","RAPORT_A","RAPORT_P");
	...
	do
		...
		//ciptakan
		$myArr2 = array($dt_nox,$dt_nis,$dt_nama,$xpel_nil_amat1,$xpel_nil_amat2,$xpel_nil_amat3,$xpel_nil_amat4,$xpel_rata_amat,$xpel_nil_dirisendiri,$xpel_nil_antarteman,$xpel_nil_catatanguru,$xpel_rata_sikap,$xpel_raport_a,$xpel_raport_p);
...
if (empty($tapelkd))
	...
	if ($s == "import")
		...
		do
			...
			<td>
			<input name="nil_rata_amat'.$i_nomer.'" type="text" value="'.$xpel_rata_amat.'" size="3" style="text-align:right" class="input" readonly>
			</td>
