...
if ($_POST['btnEX'])
	...
	$worksheet1->write_string(0,33,"SERTIFIKASI");
	$worksheet1->write_string(0,34,"SERTIFIKASI_TAHUN");
	$worksheet1->write_string(0,35,"EMAIL");
	...
	do
		...
		$worksheet1->write_string($dt_nox,33,$dt_sertifikasi_ket);
		$worksheet1->write_string($dt_nox,34,$dt_sertifikasi_tahun);
		$worksheet1->write_string($dt_nox,35,$dt_email);
		}
	...
	if ($count != 0)
		...
		do
			...
			if ($tcc1 != 0)
				...
				//masukkan ke janissari
				mysql_query("INSERT INTO m_user(kd, usernamex, passwordx, nomor, nama, tipe, postdate) VALUES ".
								"('$kd', '$usernamex', '$passwordx', '$nip', '$nama', 'PEGAWAI', '$today')");
				}
