...
//nilai
$filenya = "cd_nopinjam.php";
$judul = "Data CD : Belum Bisa Dipinjam";
...
<tr valign="top">
<td>
[<a href="cd.php?s=baru&kd='.$x.'" title="Entry Baru">Entry Baru</a>]
</td>
<td align="right">';
...
//perolehan
	...
	$sqlcount = "SELECT perpus_item3.*, perpus_item3.kd AS pitkd ".
			"FROM perpus_item3 ".
			"WHERE perpus_item3.status = 'false' ".
			"ORDER BY tglentri DESC";
	$sqlresult = $sqlcount;
...
if ($count != 0)
	...
	do
		...
		<td>
		<a href="cd.php?s=edit&kd='.$i_kd.'" title="'.$i_judul.'"><img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="cd.php?s=edit&kd='.$i_kd.'" title="'.$i_judul.'">'.$i_foto.'</a>
		</td>
		<td>
		<big>
		<font color="red">
