...
//nilai
$filenya = "majalah_nopinjam.php";
$judul = "Data Majalah : Belum Bisa Dipinjam";
...
<tr valign="top">
<td>
[<a href="majalah.php?s=baru&kd='.$x.'" title="Entry Baru">Entry Baru</a>]
</td>
<td align="right">';
...
//perolehan
	...
	$sqlcount = "SELECT perpus_item2.*, perpus_item2.kd AS pitkd ".
			"FROM perpus_item2 ".
			"WHERE perpus_item2.status = 'false' ".
			"ORDER BY tglentri DESC";
	$sqlresult = $sqlcount;
...
if ($count != 0)
	...
	do
		...
		<td>
		<a href="majalah.php?s=edit&kd='.$i_kd.'" title="'.$i_judul.'"><img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="majalah.php?s=edit&kd='.$i_kd.'" title="'.$i_judul.'">'.$i_foto.'</a>
		</td>
		<td>
		<big>
		<font color="red">
		...
		<br>
		<br>
		[...<a href="majalah.php?s=edit&kd='.$i_kd.'" title="'.$i_judul.'">SELENGKAPNYA</a>].
