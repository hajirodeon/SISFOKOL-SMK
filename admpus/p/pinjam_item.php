...
if ($_POST['btnDTI'])
	...
	if (strlen($barkode) == 13)
		{
		$barkode1 = substr($barkode,0,12);
...
function open_brg()
	...
	brg_window.onclose=function()
		...
		var barkode=this.contentDoc.getElementById("barkode");


		document.formx.item_kd.value=item_kd.value;
		document.formx.barkode.value=barkode.value;
		document.formx.barkode.focus();
		return true
		}
	}
</script>';
