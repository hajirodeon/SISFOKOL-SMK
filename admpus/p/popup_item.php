...
if ($count != 0)
	...
	do
		...
		$i_penulis3 = balikin2($data['penulis2']);
		...
		echo "<tr valign=\"top\" bgcolor=\"$warna\" onmouseover=\"this.bgColor='$warnaover';\" onmouseout=\"this.bgColor='$warna';\" onClick=\"document.formx.item_kd.value='$i_kd';document.formx.barkode.value='$i_barkode';parent.brg_window.hide();\">";
		echo '<td width="50">
		'.$i_foto.'
		</td>
		<td>
	...
	<input id="barkode" name="barkode" type="hidden" value="">
