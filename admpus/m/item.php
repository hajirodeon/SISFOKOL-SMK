		...
		//null barkode...
			...
			if ((empty($kode)) OR (empty($judul)))
				...
				if ($tcc != 0)
					...
					{
					//query
					mysql_query("INSERT INTO perpus_item(kd, kd_kategori, penulis1, penulis2, penulis2, postdate, tgl_entri, ".
							"kd_penerbit, kd_rak, kode, barkode, no_inventaris, judul, ".
							"tahun_terbit, issn_isbn, percetakan, editor, ukuran, jml_halaman, jml_halaman_i, tebal, ".
							"cetakan_ke, harga, bahasa, rangkuman, tmp_terbit, kopi_ke, tgl_masuk, status) VALUES ".
							"('$kd', '$jenis', '$penulis1', '$penulis2', '$penulis3', '$sekarang', '$sekarang', ".
							"'$penerbit', '$rak', '$kode', '$barkode', '$no_inven', '$judul', ".
							"'$tahun_terbit', '$issn_isbn', '$percetakan', '$editor', '$ukuran', '$jml_halaman', '$jml_halaman_i', '$tebal', ".
							"'$cetakan_ke', '$harga', '$bahasa', '$rangkuman', '$tmp_terbit', '$kopi_ke', '$tgl_masuk', '$status')");
	...
	//jika update
		...
		if (($tcc != 0) AND ($cc_kd != $kd))
			...
			mysql_query("UPDATE perpus_item SET kd_kategori = '$jenis', ".
					...
					"jml_halaman_i = '$jml_halaman_i', ".
					"tebal = '$tebal', ".
					"cetakan_ke = '$cetakan_ke', ".
					"harga = '$harga', ".
					"bahasa = '$bahasa', ".
					"kopi_ke = '$kopi_ke', ".
					"tmp_terbit = '$tmp_terbit', ".
					"rangkuman = '$rangkuman', ".
					"tgl_masuk = '$tgl_masuk', ".
					"postdate = '$sekarang', ".
					"tgl_entri = '$sekarang', ".
...
if (($s == "baru") OR ($s == "edit"))
	...
	Tempat Terbit :
	<br>
	<input name="tmp_terbit" type="text" value="'.$e_tmp_terbit.'" size="20" '.$x_enter2.'>
	<br>
	<br>
	...
	Ukuran :
	<br>
	<input name="ukuran" type="text" value="'.$e_ukuran.'" size="20" '.$x_enter2.'> Cm.
	<br>
	<br>
	Jumlah Halaman i :
	<br>
	<input name="jml_halaman_i" type="text" value="'.$e_jml_halaman_i.'" size="10" '.$x_enter2.'>
	<br>
	<br>

	Jumlah Halaman :
	<br>
	<input name="jml_halaman" type="text" value="'.$e_jml_halaman.'" size="10" '.$x_enter2.'>
	<br>
	<br>
	Cetakan Ke-:
	<br>
	...
	Kopi ke :
	<br>
	<input name="kopi_ke" type="text" value="'.$e_kopi_ke.'" size="10" onKeyPress="return numbersonly(this, event)" '.$x_enter2.'>
	<br>
	<br>
	...
	if ($count != 0)
		...
		do
			...
			$i_cetak_ke = nosql($data['cetakan_ke']);
			$i_jml_halaman_i = nosql($data['jml_halaman_i']);
			$i_jml_halaman = nosql($data['jml_halaman']);
			...
			<br>
			Jml.Halaman i :
			<strong><em>'.$i_jml_halaman_i.'</em></strong>
			<br>
			Jml.Halaman :
			<strong><em>'.$i_jml_halaman.'</em></strong>
			<br>
			ISSN/ISBN :
