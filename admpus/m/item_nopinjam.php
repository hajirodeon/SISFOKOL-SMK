...
//nilai
$filenya = "item_nopinjam.php";
$judul = "Item Belum Boleh Dipinjam";
			...
			if ((empty($kode)) OR (empty($judul)))
				...
				if ($tcc != 0)
					...
					mysql_query("INSERT INTO perpus_item(kd, kd_kategori, penulis1, penulis2, penulis2, ".
							...
							"cetakan_ke, harga, bahasa, rangkuman, tmp_terbit, kopi_ke, tgl_masuk, status, postdate) VALUES ".
							"('$kd', '$jenis', '$penulis1', '$penulis2', '$penulis3', ".
							"'$penerbit', '$rak', '$kode', '$barkode', '$no_inven', '$judul', ".
							"'$tahun_terbit', '$issn_isbn', '$percetakan', '$editor', '$ukuran', '$jml_halaman', '$jml_halaman_i', '$tebal', ".
							"'$cetakan_ke', '$harga', '$bahasa', '$rangkuman', '$tmp_terbit', '$kopi_ke', '$tgl_masuk', '$status', '$today')");
...
if (($s == "baru") OR ($s == "edit"))
	...
	//issn/isbn
		...
		$sqlcount = "SELECT perpus_item.*, perpus_item.kd AS pitkd ".
				"FROM perpus_item ".
				"WHERE perpus_item.status = 'false' ".
