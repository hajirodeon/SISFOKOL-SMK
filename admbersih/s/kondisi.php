...
$judulku = "[$bersih_session : $nip31_session. $nm31_session] ==> $judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if ($_POST['btnSMP'])
	...
	if (empty($kondisi))
		...
		{
		//query
		mysql_query("INSERT INTO kebersihan_kondisi(kd, kd_pegawai, kondisi, postdate) VALUES ".
				"('$x', '$kd31_session', '$kondisi', '$today')");
...
//query
$q = mysql_query("SELECT * FROM kebersihan_kondisi ".
					"WHERE kd_pegawai = '$kd31_session' ".
